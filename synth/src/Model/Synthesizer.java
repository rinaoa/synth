...
public class Synthesizer {
	...
	public final  double CIS = 	1.06;
	public final  double D = 	1.12;
	public final  double DIS = 	1.19;
	public final  double E = 	1.26;
	public final  double F = 	1.33;
	public final  double FIS = 	1.41;
	public final  double G = 	1.5;
	public final  double GIS = 	1.59;
	public final  double A = 	1.68;
	public final  double AIS = 	1.78;
	public final  double H = 	1.89;
	public final  double C2 = 	2*C;
	public final  double CIS2 = 	2*CIS;
	public final  double D2 = 	2*D;
	public final  double DIS2 = 	2*DIS;
	public final  double E2 = 	2*E;
	public final  double F2 = 	2*F;
	public final  double FIS2 = 	2*FIS;
	public final  double G2 = 	2*G;
	public final  double GIS2 = 	2*GIS;
	public final  double A2 = 	2*A;
	public final  double AIS2 = 	2*AIS;
	public final  double H2 = 	2*H;
	public final  double C3 = 	2*C2;
	...
	public final double MAX_MOD = 100;
	public  final double MIN_MOD = 0;
	public int modulation = 0;

	public boolean shouldGenerate = false;
	private int octave=0;
	
	public Oscillator modOsc = new Oscillator(this);
	private Oscillator[] oscillators = {new Oscillator(this),new Oscillator(this),new Oscillator(this)};
